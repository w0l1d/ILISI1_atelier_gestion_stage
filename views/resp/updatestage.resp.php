                            ...
                            <fieldset class="mb-3">
                                ...
                                <div class="col-auto col-lg-auto flex-grow-1  mb-2">
                                    ...
                                    <select class="form-select" required name="statue">
                                        <option value="DRAFT" <?php if ($stage['statue'] === "DRAFT") ?>>planifie
                                        </option>
                                        <option value="IN_PROGRESS" <?php if ($stage['statue'] === "IN_PROGRESS") ?>>en
                                            cours
                                        </option>
                                        <option value="CANCELLED" <?php if ($stage['statue'] === "CANCELLED") ?>>
                                            Annule
                                        </option>
                                        <option value="FINISHED" <?php if ($stage['statue'] === "FINISHED") ?>>termine
                                        </option>
                                    </select>
                                </div>
