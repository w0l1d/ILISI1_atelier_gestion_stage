...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2022 at 03:18 PM
...
(4, '2022-06-04 14:23:28.000000', '2023-04-30', 'Itaque quas ratione amet itaque voluptatum.', 259, '2022-07-27', 255, '2022-05-19', 'NEW', 'Investor Interactions Supervisor', 'PFA', '2022-06-04 14:23:28.000000', 20, 1),
(5, '2022-06-04 14:23:48.000000', '2023-05-23', 'Molestiae aperiam distinctio voluptatibus consequatur adipisci est est.', 321, '2022-09-10', 255, '2023-05-15', 'FULL', 'Senior Accounts Administrator', 'SUMMER', '2022-06-04 14:23:48.000000', 3, 1);
...
INSERT INTO `person` (`id`, `cin`, `date_naiss`, `email`, `fname`, `lname`, `password`, `phone`, `person_type`, `profile_img`) VALUES
(6, 'C4582562', '2022-05-05 00:00:00.000000', 'responsable@test.com', 'test name', 'test lname', 'password', '062548515', 'enseignant', 'iwv4TUwB1U-image.gif'),
(9, 'Lake Kathryn', '2022-06-12 00:00:00.000000', 'test@test.com', 'Eusebio Howe', 'Frida Gutmann', 'password', '500-811-7899', 'etudiant', 'Pu3RAUsLKg-istya group.jpeg'),
(10, 'Christafurt', '2022-02-15 00:00:00.000000', 'your.email+fakedata73288@gmail.com', 'Cora Beier', 'Maya Gleason', 'RsyiMTReBCQfpeg', '065-907-0059', 'etudiant', NULL),
(11, 'North Chelseabo', '2023-01-29 00:00:00.000000', 'test123@gmail.com', 'Antwon Wolf', 'Arno Rowe', 'test123', '960-206-7465', 'etudiant', NULL),
(12, 'Port Eliseoside', '2022-11-07 00:00:00.000000', 'test@gmail.com', 'Jocelyn Batz', 'Ruthie Medhurst', 'password', '626-366-6311', 'etudiant', NULL),
(13, 'Metastad', '2023-02-19 00:00:00.000000', 'admin@test.com', 'Maurice Bailey', 'Josiah Lebsack', 'password', '060-526-8261', 'etudiant', NULL),
(14, 'Champlinberg', '2022-07-21 00:00:00.000000', 'gmi_resp@test.com', 'Vicente Orn', 'Dario Auer', 'Champlinberg', '157-642-8171', 'enseignant', NULL),
(15, 'New ddd', '2023-05-11 00:00:00.000000', 'resp2@gmail.com', 'Jennie Dibbert', 'Josie Dach', 'New ddd', '642-937-3847', 'enseignant', NULL);
...
INSERT INTO `stage` (`id`, `description`, `end`, `start`, `statue`, `created_date`, `updated_date`, `entreprise_id`, `stagiaire_id`, `encardant_note`, `encadrant_ext_note`, `encadrant_id`, `candidature_id`) VALUES
(1, '5dcds545sd445sd s54sd5 ss5ff', '2022-06-15', '2022-06-10', 'DRAFT', '2022-06-05 20:46:06.000000', '2022-06-05 20:46:06.000000', 3, 9, 0, 0, 6, NULL);
